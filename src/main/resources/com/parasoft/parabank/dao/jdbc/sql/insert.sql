...
INSERT INTO News (id, date, headline, story) VALUES (1, CONCAT(YEAR(CURRENT_DATE),'-01-01'), 'Happy New Year', 'Happy New Year from all of us at ParaBank.');
INSERT INTO News (id, date, headline, story) VALUES (2, CURRENT_DATE - '37' DAY , 'ParaBank 2.0 Coming Soon', 'Our website has been serving our customers for over five years, but it is now time to look ahead to the next generation of online banking. Unfortunately our upgrade means that online banking will temporarily offline.  We apologize for any inconvenience.');
INSERT INTO News (id, date, headline, story) VALUES (3, CURRENT_DATE - '30' DAY , 'ParaBank Is Offline', 'As part of our ongoing commitment to quality for our customers, ParaBank will be offline for the next few weeks as we upgrade our systems. Look for the enhanced "ParaBank 2.0" to be available soon.  Again, we apologize for any inconvenience.');
INSERT INTO News (id, date, headline, story) VALUES (4, CURRENT_DATE, 'New! Online Account Transfers', 'ParaBank is excited to announce our new online account transfer feature. You can now use our award-winning website to transfer money between your accounts.');
INSERT INTO News (id, date, headline, story) VALUES (5, CURRENT_DATE, 'New! Online Bill Pay', 'ParaBank is excited to announce our new online bill pay feature. Utility payments may now be paid easily through our automated system.');
INSERT INTO News (id, date, headline, story) VALUES (6, CURRENT_DATE, 'ParaBank Is Now Re-Opened', 'After extensive internal upgrades, ParaBank is ready to announce that their award-winning website is available again. Look for "ParaBank 2.0" to be continuously upgraded with all of the latest features you would expect from the leading online demo bank.');
