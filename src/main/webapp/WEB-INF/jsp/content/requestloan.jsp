		...
		<table class="form2">
			<tr>
				<td align="right" width="40%"><b><fmt:message key="loan.amount" />:</b> $</td>
					<td width="20%"><input disabled id="amount" class="input"/></td>
					<td width="40%"></td>
			</tr>
			<tr>
				<td align="right" width="40%"><b><fmt:message key="down.payment" />:</b> $</td>
				<td width="20%"><input disabled id="downPayment" class="input"/></td>
				<td width="40%"></td>
			</tr>
			<tr>
				<td align="right" width="40%"><b><fmt:message key="from.account.number" />:</b></td>
				<td width="20%">
				    <select id="fromAccountId" class="input"style="visibility:hidden" >
			...
			<tr>
				...
				<td colspan="2">
					<div>
						<input id="submit" type="button" class="button" value="<fmt:message key="apply.now"/>">
					</div>
